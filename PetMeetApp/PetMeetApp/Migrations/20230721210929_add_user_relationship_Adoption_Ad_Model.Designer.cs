...
namespace PetMeetApp.Migrations
{
    ...
    [Migration("20230721210929_add_user_relationship_Adoption_Ad_Model")]
    partial class add_user_relationship_Adoption_Ad_Model
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetMeetApp.Models.AdoptionAdModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PetMeetApp.Models.NotificationModel", b =>
                {
                    ...
                    b.Property<long?>("WalkingModelId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PetMeetApp.Models.UserReferralCodeModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("CodeAppliedCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PetMeetApp.Models.WalkingModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PetMeetApp.Models.NotificationModel", b =>
                {
                    ...
                    b.HasOne("PetMeetApp.Models.WalkingModel", "WalkingModel")
                        .WithMany("Notifications")
                        .HasForeignKey("WalkingModelId");
            ...
            modelBuilder.Entity("PetMeetApp.Models.PetModel", b =>
                {
                    ...
                    b.HasOne("PetMeetApp.Models.WalkingModel", null)
                        .WithMany("Pets")
                        .HasForeignKey("WalkingModelId");
